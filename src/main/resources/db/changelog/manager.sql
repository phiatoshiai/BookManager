...
CREATE TABLE `manager` (
  ...
  `teacher_name_ahihi` varchar(45) NOT NULL,
...
CREATE TABLE `student` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_student_manager_idx` (`manager_id`),
  CONSTRAINT `fk_student_manager` FOREIGN KEY (`manager_id`) REFERENCES `manager` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-06-01 22:35:37
